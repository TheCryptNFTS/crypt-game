...
const TURN_FLOW: Basic[] = [
  ...
  {
    term: "3 · Attack",
    body: "Send your ready units at enemy units or straight at their Pyre. Guard / Taunt units must be cleared first.",
  },
  {
    term: "4 · End turn",
    body: "Pass to your opponent. Reduce the enemy Pyre to 0 to win.",
  },
];
...
const BOARD: Basic[] = [
  {
    term: "Pyre",
    body: "Your life total and the win condition. Both sides start at full Pyre health; drop the enemy's to 0 and the match is yours.",
  },
  {
    term: "Energy",
  ...
  {
    term: "Front lane",
    body: "The front row meets attackers first. Park your Guard bodies here to wall the enemy off your softer units and your Pyre.",
  },
  {
    term: "Back lane",
...
const FACTIONS: { name: string; tag: string; body: string }[] = [
  ...
  { name: "Bronze Guardians", tag: "Aggro", body: "Fast skirmishers that punish slow starts. Opens early and chips the Pyre — leans Rush & Quickstep." },
